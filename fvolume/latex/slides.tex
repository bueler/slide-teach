...
\titlegraphic{\vspace{-10mm} \includegraphics[width=0.65\textwidth]{figs/leveque13p4}}
...
% make petscPyScripts
% mkdir advectionmovie
% ./plotTS.py -mx 200 -ylabel "q" -ax 0.0 -bx 1.0 -cellcentered t.dat q.dat -oroot advectionmovie/bar
% cd advectionmovie
% eog bar*.png  % ok as live view
% ffmpeg -r 30 -f image2 -s 1920x1080 -i bar%03d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p advection.mp4
% mv advection.mp4 PATHTOSLIDETEACH/fvolume/movies
\end{frame}
...
% cd swater
% eog height*.png
% ffmpeg -r 30 -f image2 -s 1920x1080 -i height%03d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p hump.mp4
\end{itemize}
\end{frame}
...
% cd acoustics/
% eog pressure*.png
% ffmpeg -r 30 -f image2 -s 1920x1080 -i pressure%03d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p acoustics.mp4
\end{frame}
...
% cd traffic
% eog bar*.png
% ffmpeg -r 30 -f image2 -s 1920x1080 -i bar%03d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p traffic.mp4
\end{frame}
...
% ./riemann -problem swater -initial dam -da_grid_x 1000 -limiter mc -ts_monitor binary:t.dat -ts_monitor_solution binary:q.dat
% mkdir dam
% ./plotTS.py -mx 1000 -ylabel "h (height)" -ax -5.0 -bx 5.0 -dof 2 -c 0 -cellcentered t.dat q.dat -oroot dam/height
% cd dam
% eog height*.png
% ffmpeg -r 30 -f image2 -s 1920x1080 -i height%03d.png -vcodec libx264 -crf 25 -pix_fmt yuv420p dam.mp4
\end{frame}
