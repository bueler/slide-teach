...
\item E.~Bueler (2021). \emph{PETSc for Partial Differential Equations}, SIAM Press, Philadelphia
    \begin{itemize}
    \item[$\circ$] serious discussion of optimal PDE solvers, with constructions
    \end{itemize}
\item L.~Trefethen \& D.~Bau (2022). \emph{Numerical Linear Algebra}, 25th anniversary ed., SIAM Press, Philadelphia
    \begin{itemize}
